...
const recentActivity: ServiceOrderItem[] = [
  {
    ...
    execution: {
      ...
      resolutionTime: '2023-10-10T07:00:00.000Z',
    },
    detail: null,
  },
  {
...
export const EMPLOYEE_ORDERS_SUMMARY: EmployeeOrdersSummary = {
  // orders assigned to the employee with id "3"
  assignedServiceOrders,
  // Last "three" orders with status DONE or CANCELED
  recentActivity,
};
